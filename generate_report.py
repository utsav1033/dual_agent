...
findings = (
    ...
    "Recommendations\n"
    "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\n"
    "  1. LLM-as-judge scoring  Replace brittle keyword matching with a judge\n"
    "     model (Claude Haiku / GPT-4o-mini) that scores each response on a 1-5\n"
    "     rubric. Captures nuanced refusals and bias challenges that keyword\n"
    "     matching misses entirely.\n\n"
    "  2. Multi-layer guardrails  Stack three layers: (a) fast keyword blocklist\n"
    ...
    "  3. Tool use parity  OSS assistant currently has no tools. Adding the same\n"
    "     calculate / get_weather / get_datetime tools via prompt-engineered JSON\n"
    "     parsing makes the comparison architecturally fair.\n\n"
    "  4. Semantic factual scoring  Replace exact-string match with cosine\n"
    ...
    "  5. Vector memory  Replace sliding-window memory with a vector store\n"
